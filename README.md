...
[![npm version](https://badge.fury.io/js/@kollorg/occaecati-maiores.svg)](https://badge.fury.io/js/@kollorg/occaecati-maiores)
[![downloads count](https://img.shields.io/npm/dt/@kollorg/occaecati-maiores.svg)](https://www.npmjs.com/package/@kollorg/occaecati-maiores)
[![github-ci](https://github.com/kollorg/occaecati-maiores/actions/workflows/testing.yml/badge.svg)](https://github.com/kollorg/occaecati-maiores/actions/workflows/testing.yml)
...
Next, install `@kollorg/occaecati-maiores`:

```bash
npm install -D @kollorg/occaecati-maiores
```
